...
def estimate(no_missing,y_no_missing,missing):
    rfr = RandomForestRegressor(random_state=0, n_estimators=2000, n_jobs=-1)
    rfr.fit(no_missing, y_no_missing)
    predictedtime = rfr.predict(missing)
...
no_missing,missing,y_no_missing,raw_set,Raw = set_missing_time("Missing.csv","public_data1.csv")
